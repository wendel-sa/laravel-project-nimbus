        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="/images/computer-login.svg" class="image"> </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row mb-4 px-3">
                        ...
                        <h6 class="mb-0 mr-4 mt-2">Entre com:</h6>
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input class="mb-4" type="text" name="email" placeholder="Digite seu email">
                    </div>

                    <div class="row px-3"> <label class="mb-1">
                        <h6 class="mb-0 text-sm">Senha</h6>
                        </label> <input type="password" name="password" placeholder="Digite sua senha">
                    </div>
                    ...
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Não tem uma conta? <a class="text-danger " href="/register">Registre-se</a></small></div>
                </div>
            </div>
        </div>
